...
corpus: Corpus = ColumnCorpus(data_folder, columns, train_file="train.txt", dev_file="test.txt")
tag_type = 'ner'
...
search_space.add(Parameter.EMBEDDINGS, hp.choice, options=[
    StackedEmbeddings([ ELMoEmbeddings('original'), FlairEmbeddings('news-forward'), FlairEmbeddings('news-backward'), BertEmbeddings('bert-large-cased') ]),
    StackedEmbeddings([ ELMoEmbeddings('original'), FlairEmbeddings('news-forward'), FlairEmbeddings('news-backward'), BertEmbeddings('bert-large-cased'), CharacterEmbeddings() ])
])
...
param_selector = SequenceTaggerParamSelector(
    corpus,
    tag_type='ner',
    base_path="Optimisation_evals/stacks/all/test",
