...
search_space.add(Parameter.EMBEDDINGS, hp.choice, options=[
    StackedEmbeddings([ ELMoEmbeddings('original'), BertEmbeddings('bert-large-cased') ]),
    StackedEmbeddings([ ELMoEmbeddings('original'), BertEmbeddings('bert-large-cased'), CharacterEmbeddings() ])
])
...
param_selector = SequenceTaggerParamSelector(
    corpus,
    tag_type='ner',
    base_path="Optimisation_evals/stacks/ElMO_BERT/test",
