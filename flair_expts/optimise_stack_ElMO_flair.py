...
search_space.add(Parameter.EMBEDDINGS, hp.choice, options=[
    StackedEmbeddings([ ELMoEmbeddings('original'), FlairEmbeddings('news-forward'), FlairEmbeddings('news-backward') ]),
    StackedEmbeddings([ ELMoEmbeddings('original'), FlairEmbeddings('news-forward'), FlairEmbeddings('news-backward'), CharacterEmbeddings() ])
])
